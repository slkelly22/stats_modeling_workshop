...
![SAS](images/SAS.png){width="500"}  ![Stata](images/Stata.png){width="500"}

## Linear Regression Foundations

1.  Continuous outcome (Y) variable with a relatively normal distribution
2.  We are modeling a linear relationship between X and Y
